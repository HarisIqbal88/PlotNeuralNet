...
arch = [
    ...
    to_ConvConvRelu( "conv1", s_filer=4, n_filer=(1,4), offset="(0,0,0)", to="(0,0,0)", width=(3,3), height=40, depth=40, caption="ConvBlock1"),
    ...
    to_ConvConvRelu( "conv2", s_filer=8, n_filer=(4,8), offset="(2.5,0,0)", to="(pool1-east)", width=(3,3), height=40, depth=38, caption="ConvBlock2"),
    ...
    to_ConvConvRelu( "conv3", s_filer=16, n_filer=(8,16), offset="(2.5,0,0)", to="(pool2-east)", width=(3,3), height=40, depth=36, caption="ConvBlock3"),
    ...
    to_ConvConvRelu( "conv4", s_filer=32, n_filer=(16,32), offset="(2.5,0,0)", to="(pool3-east)", width=(3,3), height=37, depth=34, caption="ConvBlock4"),
    ...
    to_ConvConvRelu( "conv5", s_filer=64, n_filer=(32,64), offset="(2.5,0,0)", to="(pool4-east)", width=(3,3), height=34, depth=30, caption="ConvBlock5"),
    ...
    to_SoftMax( "SoftMaX", s_filer=2, offset="(3,0,0)", to="(fc2-east)", width=1.5, height=3, depth=25, opacity=0.8, caption="SoftMaX" ),
