...
def to_output( pathfile, to='(-3,0,0)', width=8, height=8, name="output" ):
    return r"""
\node[canvas is zy plane at x=3] (""" + name + """) at """+ to +""" {\includegraphics[width="""+ str(width)+"cm"+""",height="""+ str(height)+"cm"+"""]{"""+ pathfile +"""}};
"""
